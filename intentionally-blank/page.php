...
<div class='main-bg page-temp' id='arrow-destination'>
<?php 
...
if( have_rows('sections') ) :	
	...
	if( get_row_layout() == 'team_section' ) { get_template_part('partials/content', 'talented-team'); }

	if( get_row_layout() == 'logos_holder' ) { get_template_part('partials/content', 'logos'); }

	if( get_row_layout() == 'letter' ) { get_template_part('partials/content', 'letter'); }

	if( get_row_layout() == 'contact_layout' ) { get_template_part('partials/content', 'contact-layout'); }

	if( get_row_layout() == 'popout_forms' ) { get_template_part('partials/content', 'popout-forms'); }
endwhile; 
else: 
	the_content(); 
	endif;
